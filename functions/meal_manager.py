    ...
    def update_meal(
        ...
        if mealcalories == "Snack Calories":
            ...
            if df.at[row_index, mealcalories] == 0:
                ...
                print(
                    f"The current value for {mealcalories} is {df.at[row_index, mealcalories]}")
                snack_option = input(
                    f"Do you want to replace this value or add to it? (r = replace / a = add): ").lower()
                if snack_option == 'r':
                    df.at[row_index, mealcalories] = calories
                elif snack_option == 'a':
                    df.at[row_index, mealcalories] += calories
        ...
        if mealprotein == "Snack Protein":
            ...
            if df.at[row_index, mealprotein] == 0:
                ...
                print(
                    f"The current value for {mealprotein} is {df.at[row_index, mealprotein]}")
                snack_option = input(
                    f"Do you want to replace this value or add to it? (r = replace / a = add): ").lower()
                if snack_option == 'r':
                    df.at[row_index, mealprotein] = protein
        ...
        if mealcalories != "Snack Calories":
            ...
            if df.at[row_index, mealcalories] == 0:
                ...
                print(
                    f"The current value for {mealcalories} is {df.at[row_index, mealcalories]}")
                update_calories = input(
                    f"Do you want to replace this value with {calories}? (y/n): ").lower()
        ...
        if mealprotein != "Snack Protein":
            ...
            if df.at[row_index, mealprotein] == 0:
                ...
                print(
                    f"The current value for {mealprotein} is {df.at[row_index, mealprotein]}")
                update_protein = input(
                    f"Do you want to replace this value with {protein}? (y/n): ").lower()
                if update_protein == 'y':
                    df.at[row_index, mealprotein] = protein
